...
Clients visit our e-commerce website to browse products we have for sale. For each product we
...
- Do not use an AI generated solution.  The purpose of the exercise is to give you an opportunity to show us your engineering skills.

# Github sharing

We will be waiting for your response by 19/02/21:00 Please ensure to upload the complete coding task to your GitHub and make it private, then provide access to the following email so it can be reviewed by the Hiring Team

ssusnjar@trading-point.com
https://github.com/ssusnjar42
nquinn@xm.com
